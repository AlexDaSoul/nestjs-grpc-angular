...
dotenv.config({ path: 'builder/dev/env/common.env' });
dotenv.config({ path: 'builder/dev/env/user.env' });
dotenv.config({ path: 'builder/dev/env/todo.env' });
...
module.exports = {
    ...
    plugins: [
        ...
        new Dotenv({
            path: join(process.cwd(), './builder/dev/env/common.env'),
            systemvars: true
        }),
